...
if sys.platform == "darwin":
    if not os.path.exists('/usr/local/lib/libDynamsoftLicenseClient.dylib'):
        setup_path = get_python_lib() + '/dbr'
        dst = '/usr/local/lib'
        DLC_lib = setup_path + "/libDynamsoftLicenseClient.dylib"
        os.system("cp {} {}".format(DLC_lib, dst))
...
class EnumErrorCode(IntEnum):
    ...
    DBRERR_PANORAMA_LICENSE_INVALID = -10060
    ...
    DMERR_FAILED_TO_REACH_DLS = -20200
...
class FrameDecodingParameters:
    ...
    def __init__(self, parameters):
        ...
        self.clarity_calculation_method = parameters["ClarityCalculationMethod"]
        self.clarity_filter_mode = parameters["ClarityFilterMode"]
    ...
    def update_parameters(self, parameters):
        ...
        parameters["ClarityCalculationMethod"] = self.clarity_calculation_method
        parameters["ClarityFilterMode"] = self.clarity_filter_mode
...
class PublicRuntimeSetting:
    ...
    - deblur_modes <list[EnumDeblurMode]> : Sets the mode and priority for deblur algorithms. 
        - Value range : Each list item can be any one of the DeblurMode Enumeration items.
        - Default value : [EnumDeblurMode.DM_SKIP, EnumDeblurMode.DM_SKIP, EnumDeblurMode.DM_SKIP, EnumDeblurMode.DM_SKIP, EnumDeblurMode.DM_SKIP, EnumDeblurMode.DM_SKIP, EnumDeblurMode.DM_SKIP, EnumDeblurMode.DM_SKIP, EnumDeblurMode.DM_SKIP, EnumDeblurMode.DM_SKIP]
        - Remarks : The list index represents the priority of the item. The smaller index is, the higher priority is.

    - barcode_zone_min_distance_to_image_borders <int> : Sets barcode zone min distance to image borders.
        - Value range : [0, 0x7fffffff]
        - Default value : 0
        - Remarks : 0: means no limitation on the barcode zone min distance.
    """
    ...
    def __init__(self, settings):
        ...
        self.pdf_reading_mode = settings["PDFReadingMode"]
        self.deblur_modes = settings["DeblurModes"]
        self.barcode_zone_min_distance_to_image_borders = settings["BarcodeZoneMinDistanceToImageBorders"]
    ...
    def update_settings(self, settings):
        ...
        settings["PDFReadingMode"] = self.pdf_reading_mode
        settings["DeblurModes"] = self.deblur_modes
        settings["BarcodeZoneMinDistanceToImageBorders"] = self.barcode_zone_min_distance_to_image_borders
...
class OnedDetailedResult:
    ...
    - start_pattern_range <list[int]> : The position of the start pattern relative to the barcode location. Index 0 : X coordinate of the start position in percentage value; Index 1 : X coordinate of the end position in percentage value. 
    
    - middle_pattern_range <list[int]> : The position of the middle pattern relative to the barcode location. Index 0 : X coordinate of the start position in percentage value; Index 1 : X coordinate of the end position in percentage value. 
    
    - end_pattern_range <list[int]> : The position of the end pattern relative to the barcode location. Index 0 : X coordinate of the start position in percentage value; Index 1 : X coordinate of the end position in percentage value. 
    ...
    def __init__(self, detailed_result):
        ...
        self.start_pattern_range = detailed_result["StartPatternRange"]
        self.middle_pattern_range = detailed_result["MiddlePatternRange"]
        self.end_pattern_range = detailed_result["EndPatternRange"]
...
class QRCodeDetailedResult:
    ...
    def __init__(self, detailed_result):
        ...
        self.mode = detailed_result["Mode"]
        self.page = detailed_result["Page"]
        self.total_page = detailed_result["TotalPage"]
        self.parity_data = detailed_result["ParityData"]
...
class LocalizationResult:
    ...
    def __init__(self, localization_result):
        ...
        self.accompanying_text_bytes = None
        self.confidence = localization_result["Confidence"]

    def _convert_to_inner(self):
        ''' Init Function '''
        localization_result = {}
        localization_result["TerminatePhase"] = self.terminate_phase
        localization_result["BarcodeFormat"] = self.barcode_format
        localization_result["BarcodeFormatString"] = bytes(self.barcode_format_string, encoding='utf-8')
        localization_result["BarcodeFormat_2"] = self.barcode_format_2
        localization_result["BarcodeFormatString_2"] = bytes(self.barcode_format_string_2, encoding='utf-8')
        first_point = self.localization_points[0]
        second_point = self.localization_points[1]
        third_point = self.localization_points[2]
        fourth_point = self.localization_points[3]
        localization_result["X1"] = first_point[0]
        localization_result["Y1"] = first_point[1]
        localization_result["X2"] = second_point[0]
        localization_result["Y2"] = second_point[1]
        localization_result["X3"] = third_point[0]
        localization_result["Y3"] = third_point[1]
        localization_result["X4"] = fourth_point[0]
        localization_result["Y4"] = fourth_point[1]
        localization_result["Angle"] = self.angle
        localization_result["ModuleSize"] = self.module_size
        localization_result["PageNumber"] = self.page_number
        if self.region_name is None:
            localization_result["RegionName"] = None
        else:
            localization_result["RegionName"] = bytes(self.region_name, encoding='utf-8')
        if self.document_name is None:
            localization_result["DocumentName"] = None
        else:
            localization_result["DocumentName"] = bytes(self.document_name, encoding='utf-8')
        localization_result["ResultCoordinateType"] = self.result_coordinate_type
        localization_result["AccompanyingTextBytes"] = None
        localization_result["Confidence"] = self.confidence
...
class TextResult:
    ...
    def __init__(self, text_result):
        ...
        self.exception = text_result["Exception"]
        self.is_dpm = text_result["IsDPM"]
        self.is_mirrored = text_result["IsMirrored"]
...
class ImageData:
    ...
    def _convert_to_inner(self):
        ...
        image_data["ImagePixelFormat"] =self.image_pixel_format
        return image_data
...
class Contour:
    ...
    def _convert_to_inner(self):
        ...
        for point in self.points:
            points.append(point._convert_to_inner())
...
class LineSegment:
    ...
    def _convert_to_inner(self):
        line_segment = {}
        line_segment["StartPoint"] = self.start_point._convert_to_inner()
        line_segment["EndPoint"] = self.end_point._convert_to_inner()
        line_segment["LinesConfidenceCoefficients"] = self.lines_confidence_coefficients
        return line_segment
...
class RegionOfInterest:
    ...
    def __init__(self, region_of_interest):
        ''' Init Function '''
        self.roi_id = region_of_interest["ROIId"]
        point = region_of_interest["Point"]
    ...
    def _convert_to_inner(self):
        region_of_interest = {}
        region_of_interest["ROIId"] = self.roi_id
        region_of_interest["Point"] = self.point._convert_to_inner()
        region_of_interest["Width"] = self.width
        region_of_interest["Height"] = self.height
...
class Quadrilateral:
    ...
    Attributes:
    -----------
    - points <List[Point]> : Four vertexes in a clockwise direction of a quadrilateral. Index 0 represents the left-most vertex.
...
class IntermediateResult:
    ...
    - results <list[class]> : One of the following types: List of class Contour, List of class ImageData, List of class LineSegment, List of class LocalizationResult, List of class RegionOfInterest, List of class Quadrilateral
    ...
    - rpm_colour_argument_index <int> : The index of ForeAndBackgroundColour argument used for RegionPredetectionMode
    ...
    def __init__(self, intermediate_result):
        ...
        if type(im_results) is list:
            ...
            elif self.data_type == EnumIMResultDataType.IMRDT_QUADRILATERAL:
                for im_result in im_results:
                    self.results.append(Quadrilateral(im_result))
            elif self.data_type == EnumIMResultDataType.IMRDT_REFERENCE:
                self.results = im_results
            else:
                pass
        else:
            self.results = None
        ...
        self.rpm_colour_argument_index = intermediate_result["RPMColourArgumentIndex"]


    def _convert_to_inner(self):
        intermediate_result = {}
        intermediate_result["DataType"] = self.data_type

        im_results = []
        if self.results is not None:
            if self.data_type == EnumIMResultDataType.IMRDT_IMAGE:
                for result in self.results:
                    im_results.append(result._convert_to_inner())
            elif self.data_type == EnumIMResultDataType.IMRDT_CONTOUR:
                for result in self.results:
                    im_results.append(result._convert_to_inner())
            elif self.data_type == EnumIMResultDataType.IMRDT_LINESEGMENT:
                ...
                im_results = self.results
            else:
                pass

        intermediate_result["IMResults"] = im_results

        intermediate_result["ResultType"] = self.result_type
        intermediate_result["BarcodeComplementMode"] = self.barcode_complement_mode
        intermediate_result["BCMIndex"] = self.bcm_index
        intermediate_result["DeformationResistingMode"] = self.deformation_resisting_mode
        intermediate_result["DRMIndex"] = self.drm_index
        intermediate_result["DPMCodeReadingMode"] = self.dpm_code_reading_mode
        intermediate_result["DPMCRMIndex"] = self.dpmcrm_index
        intermediate_result["TextFilterMode"] = self.text_filter_mode
        intermediate_result["TFMIndex"] = self.tfm_index
        intermediate_result["LocalizationMode"] = self.localization_mode
        intermediate_result["LMIndex"] = self.lm_index
        intermediate_result["BinarizationMode"] = self.binarization_mode
        intermediate_result["BMIndex"] = self.bm_index
        intermediate_result["ImagePreprocessingMode"] = self.image_preprocessing_mode
        intermediate_result["IPMIndex"] = self.ipm_index
        intermediate_result["RegionPredetectionMode"] = self.region_predetection_mode
        intermediate_result["RPMIndex"] = self.rpm_index
        intermediate_result["GrayscaleTransformationMode"] = self.grayscale_transformation_mode
        intermediate_result["GTMIndex"] = self.gtm_index
        intermediate_result["ColourConversionMode"] = self.colour_conversion_mode
        intermediate_result["CICMIndex"] = self.cicm_index
        intermediate_result["ColourClusteringMode"] = self.colour_clustering_mode
        intermediate_result["CCMIndex"] = self.ccm_index
        intermediate_result["RotationMatrix"] = self.rotation_matrix
        intermediate_result["ROIId"] = self.roi_id
        intermediate_result["ScaleDownRatio"] = self.scale_down_ratio
        intermediate_result["FrameId"] = self.frame_id
        intermediate_result["RPMColourArgumentIndex"] = self.rpm_colour_argument_index
...
class DMDLSConnectionParameters:
    """ Stores DBR License Server connection parameters. """
...
class IntermediateResultCallBack(ABC):
    ...
    def intermediate_results_callback_func(frame_id, results, user_data):
        '''Sets callback function to process intermediate results generated during frame decoding. Please implement in subclass. 
            :param frame_id <int> : The ID of the frame.
            :param results <list[dict]> : The intermediate results of the frame. You can convert every item of the results to IntermediateResult Object by using IntermediateResult's constructor.
            :param user_data <object> : Customized arguments passed to your function.
        '''

class TextResultCallBack(ABC):
    @staticmethod
    @abstractmethod
    def text_results_callback_func(frame_id, results, user_data):
        '''Sets callback function to process text results generated during frame decoding. Please implement in subclass.
            :param frame_id <int> : The ID of the frame.
            :param results <list[dict]> : Recognized barcode results of the frame. You can convert every item of the results to TextResult Object by using TextResult's constructor.
            :param user_data <object> : Customized arguments passed to your function.
        '''
...
class ErrorCallBack(ABC):
    ...
    def error_callback_func(frame_id, error, user_data):
        '''Sets callback function to process errors generated during frame decoding. Please implement in subclass.
            :param frame_id <int> : The ID of the frame.
            :param error <int> : Error Code generated when decoding the frame.
            :param user_data <object> : Customized arguments passed to your function.
        '''
...
class BarcodeReader():
    ...
    - License Functions
        ...
        - init_license_from_dls(lts_connection_parameters)
    ...
    - Image Decoding Functions
        ...
        - decode_intermediate_results(intermediate_datas, template_name="")
    ...
    __dbr__ = DynamsoftBarcodeReader()

    def __init__(self):
        ''' Init Function '''
        self.version = "dbr-python 8.8"
        self.__dbr = DynamsoftBarcodeReader()
        self.__dbr.CreateInstance()
        self.dbr_version = self.__dbr.GetDBRVersion()
    

    def __del__(self):
        self.__dbr.DestoryInstance()
...
#region License Functions
    ...
    def init_license_from_license_content(self, license_key, license_content):
        ''' Initializes barcode reader license from the license content on the client machine for offline verification.
            ...
            :return error          <tuple> : error_code = error[0], error_message = error[1], if error_code != EnumErrorCode.DBR_OK, 
                you can get the detailed error message by error_message.
        '''
        error = self.__dbr.InitLicenseFromLicenseContent(license_key, license_content)
        return error
    ...
    def init_lts_connection_parameters():
        ''' Deprecated, use init_dls_connection_parameters instead.
            :return parameters  <class DMLTSConnectionParameters> : The struct DMLTSConnectionParameters with customized settings.
        '''
        cp_parameters = BarcodeReader.__dbr__.InitDLSConnectionParameters()
        parameters = DMLTSConnectionParameters(cp_parameters)
        return parameters

    @staticmethod
    def init_dls_connection_parameters():
        ''' Init DLS connection parameters.
            :return parameters  <class DMLTSConnectionParameters> : The struct DMLTSConnectionParameters with customized settings.
        '''
        cp_parameters = BarcodeReader.__dbr__.InitDLSConnectionParameters()
        parameters = DMDLSConnectionParameters(cp_parameters)
        return parameters

    @staticmethod
    def init_license_from_lts(lts_connection_parameters):
        ''' Initializes the barcode reader license and connects to the specified server for online verification. Deprecated, use init_license_from_dls instead.
            :param lts_connection_parameters <DMLTSConnectionParameters> : The struct DMLTSConnectionParameters with customized settings.
            :return error <tuple> : error_code = error[0], error_message = error[1], if error_code != EnumErrorCode.DBR_OK, 
                you can get the detailed error message by error_message. 
            :exception BarcodeReaderError : If error happens, this function will throw a BarcodeReaderError exception that can report the detailed error message.
        '''
        ...
        error = BarcodeReader.__dbr__.InitLicenseFromDLS(cp_parameters)
        if error[0] == EnumErrorCode.DMERR_LICENSE_INTERFACE_CONFLICT:
            raise BarcodeReaderError(error[1])
        else:
            return error

    @staticmethod
    def init_license_from_dls(dls_connection_parameters):
        ''' Initializes the barcode reader license and connects to the specified server for online verification.
            :param lts_connection_parameters <DMDLSConnectionParameters> : The struct DMDLSConnectionParameters with customized settings.
            :return error <tuple> : error_code = error[0], error_message = error[1], if error_code != EnumErrorCode.DBR_OK, 
                you can get the detailed error message by error_message. 
            :exception BarcodeReaderError : If error happens, this function will throw a BarcodeReaderError exception that can report the detailed error message.
        '''
        cp_parameters = BarcodeReader.__dbr__.InitDLSConnectionParameters()
        dls_connection_parameters.update_parameters(cp_parameters)
        error = BarcodeReader.__dbr__.InitLicenseFromDLS(cp_parameters)
        if error[0] == EnumErrorCode.DMERR_LICENSE_INTERFACE_CONFLICT:
            raise BarcodeReaderError(error[1])
        else:
    ...
    @staticmethod
    def get_idle_instances_count():
        ''' Get available instances count when charging by concurrent instances count.
            :return count <int> : Returns available instances count.
        '''
        count = BarcodeReader.__dbr__.GetIdleInstancesCount()
        return count
...
#region Image Decoding Functions
    ...
    def decode_file(self, image_file_name, template_name=""):
        ...
        if error_code == EnumErrorCode.DBR_OK or error_code == EnumErrorCode.DBRERR_LICENSE_EXPIRED or error_code == EnumErrorCode.DBRERR_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_RECOGNITION_TIMEOUT or \
            ...
            error_code == EnumErrorCode.DBRERR_POSTALCODE_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_DOTCODE_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_DPM_LICENSE_INVALID or \
            error_code == EnumErrorCode.DBRERR_IRT_LICENSE_INVALID or error_code == EnumErrorCode.DMERR_NO_LICENSE or error_code == EnumErrorCode.DMERR_LICENSE_BUFFER_FAILED or \
            error_code == EnumErrorCode.DMERR_LICENSE_SYNC_FAILED or error_code == EnumErrorCode.DMERR_DEVICE_NOT_MATCH or error_code == EnumErrorCode.DMERR_BIND_DEVICE_FAILED or \
            error_code == EnumErrorCode.DMERR_LICENSE_CLIENT_DLL_MISSING or error_code == EnumErrorCode.DMERR_LICENSE_INIT_SEQUENCE_FAILED or error_code == EnumErrorCode.DMERR_TRIAL_LICENSE or \
            error_code == EnumErrorCode.DMERR_FAILED_TO_REACH_DLS:
    ...
    def decode_buffer_manually(self, buffer, width, height, stride, image_pixel_format, template_name=""):
        ''' Decodes barcodes from the memory buffer containing image pixels in defined format. 
            ...
            :exception BarcodeReaderError : If error happens, this function will throw a BarcodeReaderError exception that can report the detailed error message.
        '''
        error_code = self.__dbr.DecodeBufferManually(buffer, height, width, stride, image_pixel_format, template_name)
        if error_code == EnumErrorCode.DBR_OK or error_code == EnumErrorCode.DBRERR_LICENSE_EXPIRED or error_code == EnumErrorCode.DBRERR_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_RECOGNITION_TIMEOUT or \
            error_code == EnumErrorCode.DBRERR_1D_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_QR_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_PDF417_LICENSE_INVALID or \
            error_code == EnumErrorCode.DBRERR_AZTEC_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_DATAMATRIX_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_GS1_DATABAR_LICENSE_INVALID or \
            error_code == EnumErrorCode.DBRERR_GS1_COMPOSITE_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_MAXICODE_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_PATCHCODE_LICENSE_INVALID or \
    ...
    def decode_intermediate_results(self, intermediate_results, template_name=""):
        ''' Decode barcodes from intermediate results.
            :param intermediate_results list[class IntermediateResult] : The intermediate result array for decoding.
            :param template_name(optional) <str> : The template name. 
            :return text_results <list[class TextResult]> : All text results.
            :exception BarcodeReaderError : If error happens, this function will throw a BarcodeReaderError exception that can report the detailed error message.
        '''
        inner_intermediate_results = []
        for intermediate_result in intermediate_results:
            inner_intermediate_result = intermediate_result._convert_to_inner()
            inner_intermediate_results.append(inner_intermediate_result)

        error_code = self.__dbr.DecodeIntermediateResults(inner_intermediate_results, template_name)
        if error_code == EnumErrorCode.DBR_OK or error_code == EnumErrorCode.DBRERR_LICENSE_EXPIRED or error_code == EnumErrorCode.DBRERR_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_RECOGNITION_TIMEOUT or \
            error_code == EnumErrorCode.DBRERR_1D_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_QR_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_PDF417_LICENSE_INVALID or \
            error_code == EnumErrorCode.DBRERR_AZTEC_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_DATAMATRIX_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_GS1_DATABAR_LICENSE_INVALID or \
            error_code == EnumErrorCode.DBRERR_GS1_COMPOSITE_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_MAXICODE_LICENSE_INVALID or error_code == EnumErrorCode.DBRERR_PATCHCODE_LICENSE_INVALID or \
    ...
    def get_all_intermediate_results(self):
        ''' Returns intermediate results containing the original image, the colour clustered image, the binarized image, contours, lines, text blocks, etc. 
            :return intermediate_results <list[class IntermediateResult]> : All intermediate results.
        '''
    ...
    def init_intermediate_result(self, result_type):
        ''' Init Intermediate Result.
            :param result_type <EnumIntermediateResultType> : The intermediate result array for decoding.
            :return intermediate_result <class IntermediateResult> : The intermediate result struct.
        '''
        inner_intermediate_result = self.__dbr.InitIntermediateResult(result_type)
        intermediate_result = IntermediateResult(inner_intermediate_result)
        return intermediate_result
...
#region Frame Decoding Functions
    ...
    def start_video_mode(self, frame_decoding_parameters, text_result_callback_func, template_name="", intermediate_result_callback_func=None, error_callback_func=None, user_data=None):
        ''' Starts a new thread to decode barcodes from the inner frame queue.
            ...
            :param text_result_callback_func <function pointer> : Sets callback function to process text results generated during frame decoding. 
            ...
            :param template_name(optional) <str> : The template name.
            :param intermediate_result_callback_func(optional) <function pointer> : Sets callback function to process intermediate results generated during frame decoding. 
                                                                This callback function pointer must follow the following format: callback_func_name(frameId, results, user_data); 
                                                                ...
                                                                If you would like to learn how to use it, please refer to the sample<https://github.com/Dynamsoft/python-barcode/blob/master/samples/test_DecodeVideoByCamera.py>.
            :param error_callback_func(optional) <function pointer> : Sets callback function to process errors generated during frame decoding. 
                                                                ...
                                                                If you would like to learn how to use it, please refer to the sample<https://github.com/Dynamsoft/python-barcode/blob/master/samples/test_DecodeVideoByCamera.py>.
            :param user_data(optional) <object> : Customized arguments passed to your function.
            :exception BarcodeReaderError : If error happens, this function will throw a BarcodeReaderError exception that can report the detailed error message.
        '''
        cp_frame_decoding_parameters = self.__dbr.InitFrameDecodingParameters()
        try:
            ...
            print(key)
        error_code = self.__dbr.StartVideoMode(cp_frame_decoding_parameters, text_result_callback_func, template_name, intermediate_result_callback_func, error_callback_func, user_data)
